    ...
    <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <h2 className="mt-6 text-center text-3xl font-bold text-blue-700">Sign in to your account</h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Or
            <Link href={'/signup'}><a href="#" className="font-medium text-2xl text-indigo-600 hover:text-indigo-500"> SignUp</a></Link>
          </p>
        </div>
